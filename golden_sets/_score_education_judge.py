#!/usr/bin/env python3
"""Score an LLM-judge (or HITL) against education-judge-dataset.csv.
...
same file and are the most common contamination vector.
    ...
    python _score_education_judge.py --preds judge_run1.csv [--preds2 judge_run2.csv]
    python _score_education_judge.py --selftest      # synthetic noisy judge, proves metrics
"""
...
GOLD = os.path.join(HERE, "education-judge-dataset.csv")
