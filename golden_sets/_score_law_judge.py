#!/usr/bin/env python3
"""Score an LLM-judge (or HITL) against law-judge-dataset.csv.
...
same file and are the most common contamination vector.
    ...
    python _score_law_judge.py --preds judge_run1.csv [--preds2 judge_run2.csv]
    python _score_law_judge.py --selftest      # synthetic noisy judge, proves metrics
"""
...
GOLD = os.path.join(HERE, "law-judge-dataset.csv")
